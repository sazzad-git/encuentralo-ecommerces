              ...
              <div
                className={` border  rounded-[8px] bg-white overflow-hidden ${
                  index === activeFirstIndex + 1
                    ? "lg:h-[376px] lg:w-[99.5%]  lg:transform md:translate-y-[-20px]" // Larger size for active
                    : "lg:h-[332px]  lg:w-[99.5%]" // Default size for other cards
                } h-[40%] w-[99.5%] md:w-[99.5%] md:mt-5`}
              >
                {/* className="w-full h-[166px] lg:h-[230px] lg:h-[281px]" */}
                <div
                  className={`${
                    index === activeFirstIndex + 1
                      ? "lg:h-[302px] lg:w-[389px]" // Larger size for active card
                ...
                <div className="flex justify-between p-2 lg:py-1 lg:px-4">
