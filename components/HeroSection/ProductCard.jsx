...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[26vh] md:h-[85vh] lg:h-[65vh] bg-cover bg-center mb-[20px] md:mb-[160px] lg:mb-[200px] bg-no-repeat bg-[#DFDFDF] md:bg-[url('/hero/Hero.png')]">
      <div className="absolute inset-0 md:bg-black md:bg-opacity-40 flex flex-col items-center">
        ...
        <div className="w-11/12 max-w-7xl bg-opacity-90 rounded-lg p-0 md:p-4">
          {/* Desktop View */}
...
function ProductCard({
  ...
  return (
    <div
      className="flex-shrink-0 sm:w-[185px] sm:h-[190px] md:mt-[-50px] lg:mt-0  md:h-[256px] lg:h-[320px] md:w-full  lg:w-full bg-gray-200 rounded-lg shadow-md m-2 md:m-0 px-2 overflow-visible"
      style={cardStyle}
    >
      <Image
        src={image}
        ...
        width={300}
        height={200}
        className="w-full md:h-[194px] lg:h-56 object-cover pt-[10px] md:mt-[29px] lg:mt-[59px] rounded-t-lg"
      />
